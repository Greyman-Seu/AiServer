...
if __name__ == "__main__":
    uvicorn.run(app, host=project_setting.host, port=int(project_setting.port), log_level="info", log_config=fastapi_log_config)

    # todo: 可以全覆盖：https://www.cnblogs.com/zhangliang91/p/13388200.html
